      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl pt-6 md:pt-16">
          <img 
            ...
            className="h-16 md:h-20 mb-8 md:mb-10 animate-fade-in brightness-0 invert"
          />
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6 md:mb-8 animate-fade-in">
            ...
            <span className="text-sm md:text-base font-medium text-white">USP • Stanford • Doutor em Ciências</span>
          </div>
          
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 md:mb-8 animate-slide-up leading-[1.05] text-white">
            Beleza alinhada à função
          </h1>
          
          <p className="text-lg md:text-2xl text-white/90 mb-8 md:mb-10 leading-relaxed animate-fade-in delay-150 max-w-xl">
